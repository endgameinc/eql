...
version = ".".join(eql.__version__.split(".", 2)[:2])
# The full version, including alpha/beta/rc tags
release = eql.__version__
...
latex_documents = [
    (master_doc, 'eql.tex', 'EQL Documentation',
     'Endgame', 'manual'),
]
...
man_pages = [
    (master_doc, 'eql', 'EQL Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'eql', 'EQL Documentation',
     author, 'eql', 'One line description of project.',
     'Miscellaneous'),
]
